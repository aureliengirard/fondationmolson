    ...
    $('#search-header input[type=text]').each(function (index) {
        if (index === 0) {
            if ($(this).val() === null || $(this).val() === "") {
                $("#search-header").find("input:eq(" + index + ")").css({ "border": "none", "border-bottom": "2px solid rgba(247,148,50, 1)" });
                error = false;
            } else {
...
$(document).ready(function () {
    ...
    var swiperSchedules = new Swiper('.swiper-slider-schedules', {
        pagination: null,
        slidesPerView: 3,
        paginationClickable: true,
        autoplay: 15000,
    ...
    var swiperMultyRowNews = new Swiper('.swiper-multy-row-container-news', {
        nextButton: '.swiper-portfolio-next',
        prevButton: '.swiper-portfolio-prev',
        slidesPerView: 3,
        spaceBetween: 0,
    ...
    $("input.search-input").on("keyup", function (event) {
        if ($(this).val() == null || $(this).val() == "") {
            $(this).css({ "border": "none", "border-bottom": "2px solid rgba(247,148,50, 1)" });
        } else {
